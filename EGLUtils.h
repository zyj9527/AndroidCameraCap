...
public:
	...
	static inline void orthoM(float *m, int mOffset, float left, float right, float bottom, float top, float near, float far);
	static inline void frustumM(float *m, int offset, float left, float right, float bottom, float top, float near, float far);
	static inline void setLookAtM(float *rm, int rmOffset, float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ);
...
void EGLUtils::orthoM(float *m, int mOffset, float left, float right, float bottom, float top, float near, float far)
{
...
void EGLUtils::frustumM(float *m, int offset, float left, float right, float bottom, float top, float near, float far)
{
	float r_width  = 1.0f / (right - left);
    float r_height = 1.0f / (top - bottom);
...
void EGLUtils::setLookAtM(float *rm, int rmOffset, float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ)
{
