...
status_t CameraCapture::readyToRun()
{
    ...
    sp<SurfaceControl> control = session()->createSurface(String8("CameraCapture"), dinfo.w, dinfo.h, PIXEL_FORMAT_RGB_565);
...
bool CameraCapture::threadLoop()
{
	...
	while (1)
	{
        ...
        Renderer->DrawSprite(ResourceManager::GetTexture("camera"), glm::vec2(50, 5), glm::vec2(mCamWidth, mCamHeight), 0);
